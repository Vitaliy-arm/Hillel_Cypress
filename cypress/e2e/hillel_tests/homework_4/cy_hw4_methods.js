class RegistrationPage {
    ...
    fillName(name) {
      ...
      go_to_Fuel_expenses(addMileage){
        cy.get('[routerlink="/panel/expenses"]').contains('Fuel expenses').click()
        //.contains('h1', 'Fuel expenses').should('be.visible')
        .get('td').contains(addMileage).should('be.visible');
      }
